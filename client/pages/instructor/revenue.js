...
const InstructorRevenue = () => {
    ...
    const handlePayoutSettings = async () => {
        try {
            ...
            setLoading(false)
            console.log(err)
            alert('Unable to acess payout settings. Try later')
        }
    }
                ...
                <div className='row pt-2'>  
                        <div className='col-md-8 offset-md-2 bg-light p-5'>  
                            <h2>
                                ...
                                <small>You get paid directly from stripe to your bank account every 48 hours
                            ...
                            <small>Update your stripe accoutn details or view previews payouts</small>
